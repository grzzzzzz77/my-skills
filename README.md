...
| 43 | **project-to-resume** | 深度分析本地代码项目，把架构、业务流程、模块实现、Git 贡献、AST/框架专项识别、代码图谱、文档指标和工程质量证据转成结构化分析 JSON，并通过 warning/error 一致的 strict 强校验与黄金样例标尺，稳定输出可筛选中文 HTML 报告、简历 bullet、STAR 面试话术和下游 Agent 改写 Prompt。 |
