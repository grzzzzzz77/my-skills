...
| 43 | **resume-scorecard** | 简历评分卡技能。专注对简历做 100 分质量评分、无 JD 单独评分、JD 匹配评分、ATS/可读性检查、经验年限均分对标、可信度与面试风险诊断，以及同岗位或跨行业多版本对比；默认输出评分、扣分原因、年限段参考均分、提分杠杆和中文 HTML 报告，不默认改写简历。 |
